...
import { ListOfContentContainer, MainContent, SingleContentElementText, SingleContentElementBottomMobile, SingleContentElementBottom, SingleContentHeaderElement , SingleContentElement, UL} from './style'
        ...
        return (
          <UL key={elem.id}>
            <MainContent>
              ...
              <SingleContentElement>
                <SingleContentElementBottomMobile>Carb</SingleContentElementBottomMobile>
                <SingleContentElementBottomMobile>ICON</SingleContentElementBottomMobile>
              </SingleContentElement>
              <SingleContentElement>
