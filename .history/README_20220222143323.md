...
ContentData maps and renders data that fetched from api

### [ContentHours](https://github.com/TomaszBeben/getresponse/blob/main/src/components/content/ContentData.tsx)
ContentData maps and renders data that fetched from api